...
from cleanflux.config import default_config
from cleanflux.config.object_view import ObjectView
from cleanflux.config.smart_formatter import SmartFormatter
...
def parse_args(args=sys.argv[1:]):
    parser = argparse.ArgumentParser(description='cleanflux - An InfluxDB proxy that sanitizes output of InfluxDB queries with bad behaviours',
